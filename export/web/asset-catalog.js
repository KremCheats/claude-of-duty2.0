export const PENDING_ASSETS = Object.freeze({
  guns: Object.freeze([
    { id: 'ballista_r2', name: 'Ballista', bucket: 'guns', source: 'black-ops-2-ballista.zip', targetId: 'ballista', status: 'replacement-candidate' },
    { id: 'dsr50_r2', name: 'DSR-50', bucket: 'guns', source: 'black-ops-2-dsr-50.zip', targetId: 'dsr50', status: 'replacement-candidate' },
    { id: 'fal_osw_r2', name: 'FAL OSW', bucket: 'guns', source: 'black-ops-2-fal-osw.zip', targetId: 'sa58', status: 'replacement-candidate' },
    { id: 'hamr', name: 'HAMR', bucket: 'guns', source: 'black-ops-2-hamr.zip', targetId: 'hamr', status: 'pending-conversion' },
    { id: 'locus', name: 'Locus', bucket: 'guns', source: 'locus-sniper.zip', targetId: 'locus', status: 'pending-conversion' },
    { id: 'dlq33', name: 'DLQ33', bucket: 'guns', source: 'dlq33-holidays.zip', targetId: 'dlq33', status: 'pending-conversion' },
  ...
  maps: Object.freeze([
    ...
    { id: 'alcatraz', name: 'Alcatraz', bucket: 'maps2', source: 'alcatraz.zip', status: 'pending-conversion' },
  ]),
